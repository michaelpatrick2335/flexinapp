# Flexin Meditation App — App Store Connect Listing
...
```
Meet Flexin — your pocket-sized meditation buddy.

Flexin helps you build a real meditation habit with short, friendly sessions you'll actually finish. No 45-minute lectures, no incense-and-incantation vibes. Just simple breathwork, guided sits, and a journal that grows with you.
...
Open the app, pick a session, breathe. After, jot a note in your journal. That's it. Flexin learns what works for you and suggests sessions that match your mood and schedule.

PRICING

Try Flexin free for 3 days — full access, no limits. After your trial, Flexin Premium is $6.99/month. Cancel anytime in your Apple ID settings.
...
Privacy Policy: https://www.flexinapp.com/privacy
Terms of Service: https://www.flexinapp.com/terms
...
```
meditation,mindfulness,calm,breathwork,sleep,anxiety,focus,zen,journal,relax,stress,breathe,flexin
```
*(98/100 chars)*

**Strategy:** Mix of high-volume terms (meditation, calm, sleep, anxiety) + your brand (flexin) + practice-specific (breathwork, journal, zen). Don't repeat words from your app name/subtitle — Apple indexes those automatically.

---

## Support URL
```
https://www.flexinapp.com/support
```
*(You'll need to make this page exist before submission — even a simple "Contact us: support@flexinapp.com" page works)*
...
```
https://www.flexinapp.com/privacy
```
...
```
Welcome to Flexin. This is our first release on the App Store.
...
Try us free for 3 days. We hope Flexin becomes part of your daily calm.
```
...
```
Username: appreview@flexinapp.com
Password: (create this account now — see note below)

Notes: The app uses a free 3-day trial then $6.99/month subscription. Reviewers can sign in with the credentials above to access all features. Account creation is handled on the web at flexinapp.com/signup and the in-app "Create Account" button links there per App Store Review Guideline 3.1.3(b).
```

**ACTION ITEM:** Before submitting, create a real account on flexinapp.com called `appreview@flexinapp.com` with a memorable password and grant it free premium access in your DB so reviewers can test all paid features. I can do this for you when we get to submission.
...
Apple's privacy questionnaire. Answer truthfully based on what flexinapp.com actually collects:
...
- **Product ID:** `com.flexinapp.meditation.premium.monthly`
- **Reference Name:** Flexin Premium Monthly
- **Price:** Tier 7 ($6.99 USD)
- **Subscription Group:** Flexin Premium
- **Subscription Duration:** 1 month
- **Free Trial:** 3 days (introductory offer)
- **Display Name:** Flexin Premium
...
- [ ] Description set
- [ ] Keywords set
- [ ] Support URL works (create `/support` page on flexinapp.com)
- [ ] Privacy Policy URL works (create `/privacy` page on flexinapp.com)
- [ ] Terms of Service URL works (create `/terms` page)
- [ ] Category: Health & Fitness
- [ ] Age Rating questionnaire: all None → 4+
- [ ] Copyright set
- [ ] Contact info filled
- [ ] Reviewer sign-in account created (`appreview@flexinapp.com`)
