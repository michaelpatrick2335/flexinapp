...
// Muscle activation model (inlined to ensure Vercel bundles it).
// Source data: client/src/data/muscleContribution.json + MUSCLE_MODEL.md.
const MUSCLE_MAP: Record<string, Record<string, number>> = {
...
const MUSCLE_GROUP_AGG: Record<string, string> = {
  chest: "chest", back: "back", shoulders: "shoulders",
  biceps: "arms", triceps: "arms", forearms: "arms",
  quads: "legs", glutes: "legs", hamstrings: "legs", calves: "legs",
  core_abs: "core",
};
function normalizeExerciseKey(name: string): string | null {
...
async function computeMuscleGroups(pool: any, userId: number) {
  const GROUPS = [
  ...
  try {
    const r = await pool.query(
      `SELECT exercise_names, completed_at FROM workouts
